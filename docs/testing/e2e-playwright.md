...
OIDC E2E is intentionally absent while callback routes, protected runtime configuration, Identity,
and Gateway are not activated; durable storage alone does not claim a public flow. When activated,
