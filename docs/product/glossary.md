...
- **Import run**: durable, resumable ingestion attempt with preview, evidence, and review outcomes.
- **Resolution**: merge, split, or link decision between observations and canonical Places.
- **Family navigation**: workspace-composed service destinations consumed through a versioned manifest.
