...
Delivery state is **source-only; Stages 6.5 and 7.5–7.10 complete, with Stages 2 and 7 in progress and Stage 8 paused after 8B**. A Place-owned physical PostGIS runtime is
