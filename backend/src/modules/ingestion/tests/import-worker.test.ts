...
describe('acquisition worker interface', () => {
  it('stores one sanitized capture and records provider-neutral preview items', async () => {
    ...
    const ids = [
      ...
      '01992d20-7200-7000-8000-000000000021',
      '01992d20-7200-7000-8000-000000000022',
      '01992d20-7200-7000-8000-000000000023',
    ]
    ...
    expect(recorded[0]).toMatchObject({
      ...
      items: [{
        ...
        detail: {
          jobId: '01992d20-7200-7000-8000-000000000021',
          observationId: '01992d20-7200-7000-8000-000000000022',
          candidateId: '01992d20-7200-7000-8000-000000000023',
        },
      }],
    })
