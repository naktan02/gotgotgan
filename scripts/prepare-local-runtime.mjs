...
if (clientId !== undefined && clientId !== '') {
  ...
  const values = {
    ...
    PLACE_IMPORT_MATERIALIZATION_LEASE_MILLISECONDS: '60000',
    PLACE_IMPORT_MATERIALIZATION_IDLE_MILLISECONDS: '1000',
    PLACE_IMPORT_MATERIALIZATION_MAXIMUM_JOBS: '10000',
    ...
    PLACE_OIDC_STARTUP_RETRY_ATTEMPTS: '90',
