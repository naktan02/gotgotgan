...
describe('Collection-first Personal Library view', () => {
  it('offers a first user category without legacy favorite states', () => {
    const workflow = {
      ...
      mobileSurface: 'collections',
      collectionQuery: '', placeQuery: '',
      areaKeys: [], taxonomyKeys: [], taxonomyOptions: [], tagIds: [], tags: [], ratingFilter: 'any',
      loadingCollections: false,
      mapViewport: { bounds: { west: 126, south: 37, east: 128, north: 38 }, zoom: 12 },
      mapSelection: { kind: 'all' },
