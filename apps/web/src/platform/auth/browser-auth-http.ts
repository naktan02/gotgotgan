...
import type { createOidcBff } from './oidc-bff'
import { readNextOidcRuntime } from './next-oidc-lifecycle'

type BrowserAuthRuntime = Readonly<{
  bff: ReturnType<typeof createOidcBff>
}>

type BrowserAuthHttpDependencies = Readonly<{
...
export const browserAuthHttp = createBrowserAuthHttp({
  resolveRuntime: readNextOidcRuntime,
